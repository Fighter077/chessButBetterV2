...
public class QueueServiceImpl implements QueueService {
    ...
    public QueueServiceImpl(
            GameService gameService, QueueRepository queueRepository, QueueSender queueSender) {
    ...
    public void findMatch(User user) {
        ...
        if (matchedUser.isPresent()) {
            User opponent = matchedUser.get().getUser();
    ...
    public void cancelMatch(User user) {
        ...
        Optional<QueueEntry> queueEntry = queueRepository.findByUser(user);
